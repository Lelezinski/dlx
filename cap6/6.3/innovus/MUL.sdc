...
# Created by write_sdc on Tue Jun 13 23:25:16 2023
...
set_max_delay 10  -from [list [get_ports {A[31]}] [get_ports {A[30]}] [get_ports {A[29]}]       \
...
{B[2]}] [get_ports {B[1]}] [get_ports {B[0]}]]  -to [list [get_ports {P[63]}] [get_ports {P[62]}] [get_ports {P[61]}]         \
